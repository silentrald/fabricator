<template>
  <!-- heart icon by Free Icons (https://free-icons.github.io/free-icons/) -->
  <svg xmlns="http://www.w3.org/2000/svg" class="icon" height="1em" fill="currentColor" viewBox="0 0 512 512">
